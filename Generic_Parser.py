...
import sys
import time
# sys.path.append(r'C:\Users\Guanr\Downloads\LM&Parser')  # Modify to identify path for custom modules
sys.path.append(r'C:/code/s-p500-10-Q-sentiment-return-analysis/')  # Modify to identify path for custom modules
import Load_MasterDictionary as LM

# User defined directory for files to be parsed
TARGET_FILES = r'C:/code/s-p500-10-Q-sentiment-return-analysis/sec_parser_10Q_txt/*.*'
# User defined file pointer to LM dictionary
MASTER_DICTIONARY_FILE = r'C:\code\s-p500-10-Q-sentiment-return-analysis\LoughranMcDonald_MasterDictionary_2018.csv'
# User defined output file
OUTPUT_FILE = r'C:\code\s-p500-10-Q-sentiment-return-analysis\Parser_motherload.csv'
# Setup output
